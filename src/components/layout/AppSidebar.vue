...
<script setup>
      ...
      items: [
        {
          ...
          name: 'Agentic',
          subItems: [
            { name: 'Tổng quan', path: '/agentic', pro: false },
            { name: 'Perception', path: '/agentic/perception', pro: false },
            { name: 'Planning', path: '/agentic/planning', pro: false },
  ...
  const isActive = (path) => {
    // Special handling for agentic routes - check if current path starts with /agentic
    if (path === '/agentic') {
      return route.path === '/agentic';
    }
    return route.path === path || (route.path.startsWith('/agentic') && path.startsWith('/agentic'));
  };
